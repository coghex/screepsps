...
(function($PS) {
              ...
              return function (v) {
                  if (v instanceof Screeps_Types.RoleHarvester) {
                      return function __do() {
                          ...
                          throw new Error("Failed pattern match at Creep (line 104, column 5 - line 106, column 56): " + [ res.constructor.name ]);
                      };
                  };
                  if (v instanceof Screeps_Types.RoleNULL) {
                      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                  };
                  throw new Error("Failed pattern match at Creep (line 100, column 1 - line 101, column 32): " + [ spawn.constructor.name, parts.constructor.name, name.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
  ...
  var calcRoleScore = function (creeps) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Creep (line 64, column 1 - line 64, column 43): " + [ creeps.constructor.name, v.constructor.name ]);
      };
  };
              ...
              return function ($copy_role) {
                  ...
                  function $tco_loop(v, v1, v2, role) {
                      ...
                      var scores$prime = (function () {
                          ...
                          throw new Error("Failed pattern match at Creep (line 87, column 20 - line 89, column 34): " + [ v3.constructor.name ]);
                      })();
                      var score$prime = (function () {
                          ...
                          throw new Error("Failed pattern match at Creep (line 90, column 20 - line 92, column 33): " + [ v3.constructor.name ]);
                      })();
                      var roles$prime = (function () {
                          ...
                          throw new Error("Failed pattern match at Creep (line 81, column 20 - line 83, column 34): " + [ v3.constructor.name ]);
                      })();
                      var role$prime = (function () {
                          ...
                          throw new Error("Failed pattern match at Creep (line 84, column 20 - line 86, column 40): " + [ v3.constructor.name ]);
                      })();
          ...
          return function (mem) {
              ...
              if ($39) {
                  return function __do() {
                      ...
                      throw new Error("Failed pattern match at Creep (line 39, column 5 - line 43, column 40): " + [ spawn1.constructor.name ]);
                  };
              };
              return function __do() {
                  ...
                  var creeps = (function () {
                      ...
                      throw new Error("Failed pattern match at Creep (line 50, column 16 - line 52, column 38): " + [ creeps$prime.constructor.name ]);
                  })();
                  ...
                  Screeps_Memory.set(Data_Argonaut_Encode_Class.encodeJsonInt)(mem)("utility")(0)();
                  return Effect_Console.log("U(n-1): " + (Data_Show.show(Data_Show.showInt)(0) + (", U(n): " + Data_Show.show(Screeps_Types.showRole)(alternative))))();
              };
          };
      };
  };
