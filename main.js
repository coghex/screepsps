...
(function($PS) {
  ...
  var encodeLoopStatus = {
      encodeJson: function (v) {
          ...
          throw new Error("Failed pattern match at Screeps.Types (line 131, column 1 - line 134, column 48): " + [ v.constructor.name ]);
      }
  };
              ...
              return function (v) {
                  if (v instanceof Screeps_Types.RoleHarvester) {
                      return function __do() {
                          ...
                          throw new Error("Failed pattern match at Creep (line 76, column 5 - line 78, column 57): " + [ res.constructor.name ]);
                      };
                  };
                  if (v instanceof Screeps_Types.RoleNULL) {
                      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                  };
                  throw new Error("Failed pattern match at Creep (line 73, column 1 - line 73, column 75): " + [ spawn.constructor.name, parts.constructor.name, name.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
              ...
              return function ($copy_v1) {
                  ...
                  function $tco_loop(util, n, v, v1) {
                      ...
                      var n$prime = (function () {
                          ...
                          throw new Error("Failed pattern match at Creep (line 63, column 21 - line 65, column 28): " + [ v2.constructor.name ]);
                      })();
                      var creepmem$prime = (function () {
                          ...
                          throw new Error("Failed pattern match at Creep (line 60, column 21 - line 62, column 29): " + [ v2.constructor.name ]);
                      })();
                      $tco_var_util = util;
          ...
          return function (mem) {
              ...
              if ($25) {
                  return function __do() {
                      ...
                      throw new Error("Failed pattern match at Creep (line 34, column 5 - line 36, column 41): " + [ spawn1.constructor.name ]);
                  };
              };
              return function __do() {
                  ...
                  var init$prime = (function () {
                      ...
                      if (init instanceof Data_Either.Right) {
                          ...
                          throw new Error("Failed pattern match at Creep (line 43, column 31 - line 45, column 39): " + [ init.value0.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Creep (line 39, column 14 - line 45, column 39): " + [ init.constructor.name ]);
                  })();
