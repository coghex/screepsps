...
(function($PS) {
  ...
  var encodeRole = {
      encodeJson: function (v) {
          ...
          throw new Error("Failed pattern match at Screeps.Types (line 174, column 1 - line 177, column 51): " + [ v.constructor.name ]);
      }
  };
  var encodeLoopStatus = {
      encodeJson: function (v) {
          ...
          throw new Error("Failed pattern match at Screeps.Types (line 192, column 1 - line 195, column 48): " + [ v.constructor.name ]);
      }
  };
  var decodeRole = {
