...
(function($PS) {
  ...
  var eqRoles = {
      eq: function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Screeps.Types (line 150, column 1 - line 154, column 41): " + [ v.constructor.name, v1.constructor.name ]);
          };
      }
  };
  var eqReturnCode = {
  ...
  var encodeRole = {
      encodeJson: function (v) {
          ...
          throw new Error("Failed pattern match at Screeps.Types (line 156, column 1 - line 158, column 51): " + [ v.constructor.name ]);
      }
  };
  var encodeLoopStatus = {
      encodeJson: function (v) {
          ...
          throw new Error("Failed pattern match at Screeps.Types (line 172, column 1 - line 175, column 48): " + [ v.constructor.name ]);
      }
  };
  var decodeRole = {
...
(function($PS) {
  ...
  var moveTo = function (creep) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Screeps.Creep (line 101, column 1 - line 101, column 67): " + [ creep.constructor.name, v.constructor.name ]);
      };
  };                                           
...
(function($PS) {
  ...
  var Screeps_Types = $PS["Screeps.Types"];                
  var getFreeCapacity = Control_Applicative.pure(Effect.applicativeEffect)(1);
  ...
  var preformHarvester = function (creep) {
      return function __do() {
          ...
          var $2 = freeCapacity > 0;
          if ($2) {
              var isSource = function (v) {
                  return true;
              };
              var sources = Screeps_Room["find'"](Screeps_Room.room(creep))(Screeps_Const.find_sources)(isSource);
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  var $5 = Data_Eq.eq(Screeps_Types.eqReturnCode)(harv)(Screeps_Const.err_not_in_range);
                  if ($5) {
