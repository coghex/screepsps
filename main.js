...
(function($PS) {
  ...
  var calcUtility = function (util) {
      return function (array) {
          return Control_Applicative.pure(Effect.applicativeEffect)(util);
      };
  };
          ...
          return function __do() {
              ...
              var init$prime = (function () {
                  ...
                  if (init instanceof Data_Either.Right) {
                      ...
                      throw new Error("Failed pattern match at Creep (line 28, column 29 - line 30, column 37): " + [ init.value0.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Creep (line 24, column 12 - line 30, column 37): " + [ init.constructor.name ]);
              })();
              var $$new = calcUtility(init$prime)(array)();
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      Creep.processCreeps(creeps)(memory)();
