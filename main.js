          ...
          return function (v) {
              if (v instanceof Screeps_Types.LoopGo) {
                  ...
                  return function __do() {
                      ...
                      throw new Error("Failed pattern match at Main (line 68, column 3 - line 70, column 25): " + [ tower.constructor.name ]);
                  };
              };
              ...
              throw new Error("Failed pattern match at Main (line 53, column 1 - line 53, column 83): " + [ game.constructor.name, memory.constructor.name, v.constructor.name ]);
          };
      };
  };
